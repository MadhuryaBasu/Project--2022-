...
path = 'C:/Py_Project_folder'
print('-' * 110)
txt="Develop by Mis. Madhurya Basu"
x=txt.center(110)
print(x)
print('-' * 110)
...
def grade(num):
    if num >= 90:
        ...
        return ("You have barely passed the exam with grade E.")
    else:
...
def get_batch():
    with open(f'C:/Py_Project_folder/Batch.csv', 'r') as f:
        reader = csv.reader(f)
...
def remove(string):
    with open(f'C:/Py_Project_folder/Student.csv', 'r+', newline='') as f:
        script = csv.reader(f)
...
while message:
    ...
    with open(f'{path}/Department.csv', 'a', newline='') as f:
        ...
        script.writerow(['CSEIOTCSBS', 'CSEIOTCSBS :- Computer Sience and Engineering and Internet of Things and Business Studies'])
...
print('\n', '1. CSEAI :- Computer Sience and Engineering and Artificial Intelligence', '\n',
      '2. CSEAIML :- Computer Sience and Engineering and Artificial Intelligence and Machine Learning', '\n',
      '3. CSEIOTCSBS :- Computer Sience and Engineering and Internet of Things and Business Studies', '\n',
      '4. CSE :-Computer Sience and Engineering', '\n'
      '5. ECE :- Electrical and Communications Engineering', '\n',
      '6. IT :- Information Technology', '\n',
      '7. ME :- Mechanical Engineering ', '\n',
           )
print("Please write all the stream name in short only")
print()

student_no = int(input("Enter the no. of students whose data you want to take: "))
print()
print('-' * 110)
for i in range(student_no):
    name = input("Enter Student's Name : ").upper()
    batch = input("Which batch they are in (e.g. 2022-26) : ")
    stream = input("Which Stream are you in (e.g. CSE) : ").upper()
    ...
    if duplicate('Student.csv', student_id, 0):
        ...
        print('please enter the subjects marks in the above mentioned order in a list type and use "null" \n if you dont have a particular subject write there  (e.g. [69,54,73,85,"null",91])')
        ...
        with open(f"{path}/ReportCards/{student_id}_{''.join(name.split())}.txt", 'w') as f:
            ...
            f.writelines([f'GRADTION/REPORT CARD \n',
                          f'**************************************************************************************** \n',
...
batch = input("Which batch they are in (e.g. 2022-26) : ")
stream = input("Which Stream are they in (e.g. CSE) : ").upper()
